...
function renderHomepageBody() {
  return `<section class="recognition section" id="situaciones" aria-labelledby="situations-title">
    ...
    <div class="situation-grid" data-reveal>
      <article class="situation-card"><span class="card-number">01</span><h3 class="card-title">Deuda hipotecaria</h3><p class="card-copy">El dividendo o las obligaciones asociadas a la propiedad se volvieron difíciles de sostener.</p><div class="situation-card-actions"><a href="#conversemos" data-select-situation="mora_hipotecaria" data-analytics-cta-id="situation_mortgage" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-con-deudas">Entender la evaluación</a></div></article>
      <article class="situation-card"><span class="card-number">02</span><h3 class="card-title">Propiedad desocupada</h3><p class="card-copy">La casa o departamento está vacío, deteriorándose o generando gastos todos los meses.</p><div class="situation-card-actions"><a href="#conversemos" data-select-situation="propiedad_abandonada" data-analytics-cta-id="situation_vacant" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-en-mal-estado">Evaluar su condición</a></div></article>
