...
function renderHomepageBody() {
  return `<section class="recognition section" id="situaciones" aria-labelledby="situations-title">
    ...
    <div class="situation-grid" data-reveal>
      ...
      <article class="situation-card"><span class="card-number">05</span><h3 class="card-title">Necesitas vender pronto</h3><p class="card-copy">Tu prioridad es tener una evaluación realista y avanzar sin meses de incertidumbre.</p><div class="situation-card-actions"><a href="/vender-propiedad-rapido#conversemos" data-analytics-cta-id="situation_urgent_sale" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-rapido">Revisar variables</a></div></article>
