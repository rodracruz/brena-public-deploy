...
function renderHeader(page) {
  ...
  return `<header class="site-header" data-header>
    <div class="shell header-inner">
      <a class="brand" href="/" aria-label="BRENA, inicio"><img src="/brena.png" width="500" height="115" alt="BRENA"></a>
  ...
  return `<section class="${home ? "hero" : "page-hero"}" id="inicio" aria-labelledby="hero-title">
    <div class="shell ${home ? "hero-grid" : "page-hero-grid"}">
      <div class="hero-copy" data-reveal>
        ...
        <ul class="trust-list" aria-label="Características del servicio">${trustItems.map((item) => `<li><span aria-hidden="true">✓</span> ${item}</li>`).join("")}</ul>
      </div>
...
function renderHomepageBody() {
  return `<section class="recognition section" id="situaciones" aria-labelledby="situations-title">
    <div class="shell"><div class="section-heading section-heading-split" data-reveal><div><p class="eyebrow"><span></span> Cada propiedad tiene una historia</p><h2 id="situations-title">Hay situaciones que no se resuelven publicando un aviso.</h2></div><p>Cuando una propiedad empieza a acumular costos, trámites o incertidumbre, necesitas entender tus alternativas antes de tomar una decisión.</p></div>
    <div class="situation-grid" data-reveal>
      <article class="situation-card"><span class="card-number">01</span><h3 class="card-title">Deuda hipotecaria</h3><p class="card-copy">El dividendo o las obligaciones asociadas a la propiedad se volvieron difíciles de sostener.</p><div class="situation-card-actions"><a href="/vender-propiedad-con-deudas#conversemos" data-select-situation="mora_hipotecaria" data-analytics-cta-id="situation_mortgage" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-con-deudas">Entender la evaluación</a></div></article>
      <article class="situation-card"><span class="card-number">02</span><h3 class="card-title">Propiedad desocupada</h3><p class="card-copy">La casa o departamento está vacío, deteriorándose o generando gastos todos los meses.</p><div class="situation-card-actions"><a href="/vender-propiedad-en-mal-estado#conversemos" data-select-situation="propiedad_abandonada" data-analytics-cta-id="situation_vacant" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-en-mal-estado">Evaluar su condición</a></div></article>
      ...
      <article class="situation-card"><span class="card-number">05</span><h3 class="card-title">Necesitas vender pronto</h3><p class="card-copy">Tu prioridad es tener una evaluación realista y avanzar sin meses de incertidumbre.</p><div class="situation-card-actions"><a href="/vender-propiedad-rapido#conversemos" data-select-situation="necesita_vender_rapido" data-analytics-cta-id="situation_urgent_sale" data-analytics-cta-location="situations">Quiero conversar</a><a href="/vender-propiedad-rapido">Revisar variables</a></div></article>
  ...
  <section class="process section" id="proceso" aria-labelledby="process-title"><div class="shell process-grid"><div class="process-intro" data-reveal><p class="eyebrow eyebrow-light"><span></span> Un proceso sin letra chica</p><h2 id="process-title">Claridad antes de cualquier decisión.</h2><p>No todas las propiedades ni todas las situaciones son iguales. Por eso no hacemos promesas antes de revisar los antecedentes básicos.</p><a class="button button-light" href="#conversemos" data-analytics-cta-id="process_form" data-analytics-cta-location="process">Empezar una conversación</a></div><ol class="steps" data-reveal><li><span class="step-number">01</span><div><h3>Nos cuentas qué está pasando</h3><p>Solo pedimos información básica para entender la propiedad, tu objetivo y el nivel de urgencia.</p></div></li><li><span class="step-number">02</span><div><h3>Revisamos el caso</h3><p>El equipo Brena ordena la información y determina qué antecedentes hacen falta para evaluar alternativas reales.</p></div></li><li><span class="step-number">03</span><div><h3>Te damos una respuesta clara</h3><p>Te explicamos si podemos ayudarte, qué camino vemos y cuáles serían los próximos pasos. Tú decides si avanzar.</p></div></li></ol></div></section>
  <section class="perspective section" aria-labelledby="perspective-title" itemprop="publisher" itemscope itemtype="https://schema.org/Organization" itemid="${escapeHtml(SITE_IDENTITY.organizationId)}"><link itemprop="url" href="${escapeHtml(SITE_IDENTITY.siteUrl)}"><link itemprop="logo" href="${escapeHtml(SITE_IDENTITY.logoUrl)}"><meta itemprop="name" content="${escapeHtml(SITE_IDENTITY.name)}"><meta itemprop="description" content="${escapeHtml(SITE_IDENTITY.description)}"><div class="shell perspective-grid"><div class="perspective-image" data-reveal><img src="/casa2.jpg" width="640" height="853" alt="Vista exterior de una vivienda contemporánea" loading="lazy"><div class="image-caption"><span>Brena</span> Gestión inmobiliaria</div></div><div class="perspective-copy" data-reveal><p class="eyebrow"><span></span> Una mirada completa</p><h2 id="perspective-title">Una propiedad es más que un precio de publicación.</h2><p class="large-copy" data-page-editorial>También son deudas, costos mensuales, estado legal, tiempo disponible y las decisiones de las personas que están detrás.</p><p>En Brena reunimos esos factores para comprender el caso completo. La primera conversación no te obliga a vender ni reemplaza asesoría legal o financiera independiente: te permite saber si existe un camino que valga la pena evaluar.</p><div class="principles"><div><span>01</span><strong>Sin juicios</strong><small>Escuchamos la situación tal como es.</small></div><div><span>02</span><strong>Sin presión</strong><small>Tú decides si quieres continuar.</small></div><div><span>03</span><strong>Sin falsas certezas</strong><small>Evaluamos antes de prometer.</small></div></div></div></div></section>`;
}
...
function renderFaq(page) {
  ...
  const intro = page.route === "/"
    ? "Si tu pregunta no aparece aquí, puedes incluirla en el formulario. Revisaremos el contexto antes de responder."
    : "La respuesta final depende de los antecedentes de cada propiedad.";
  return `<section class="faq section" id="preguntas" aria-labelledby="faq-title"><div class="shell faq-grid"><div class="faq-intro" data-reveal><p class="eyebrow"><span></span> Antes de conversar</p><h2 id="faq-title">Preguntas honestas. Respuestas directas.</h2><p>${intro}</p></div><div class="faq-list" data-reveal>${faqs.map((faq) => `<details><summary>${escapeHtml(faq.question)}<span aria-hidden="true">+</span></summary><p>${escapeHtml(faq.answer)}</p></details>`).join("")}${page.officialSource ? `<p class="source-note">Fuente oficial de referencia: <a href="${escapeHtml(page.officialSource.url)}" rel="noopener noreferrer">${escapeHtml(page.officialSource.label)}</a>. Consultada el 29 de agosto de 2026.</p>` : ""}</div></div></section>`;
}

function renderContact(page) {
  const home = page.route === "/";
  const brandName = home ? "Brena" : "BRENA";
  const responsible = home ? "Brena Gestión Inmobiliaria" : "BRENA";
  return `<section class="contact-section section" id="conversemos" aria-labelledby="contact-title"><div class="shell contact-grid"><div class="contact-copy" data-reveal><p class="eyebrow eyebrow-light"><span></span> Hablemos de tu propiedad</p><h2 id="contact-title">Cuéntanos lo esencial. Nosotros hacemos las preguntas correctas.</h2><p>Completar este formulario toma cerca de dos minutos. No necesitas tener documentos ni cifras exactas para comenzar.</p><ul><li><span aria-hidden="true">✓</span> Información tratada de forma confidencial</li><li><span aria-hidden="true">✓</span> Sin documentos para comenzar</li><li><span aria-hidden="true">✓</span> Sin obligación de continuar</li></ul></div><div class="form-card" data-reveal><div class="form-topline"><span data-step-label>Paso 1 de 2</span><div class="progress-track" aria-hidden="true"><span data-progress></span></div></div><!-- lead-form:start -->${renderLeadForm({ relatedSituation: page.relatedSituation })}<!-- lead-form:end --><div class="success-state" data-success-state tabindex="-1" hidden><span class="success-icon" aria-hidden="true">✓</span><p class="eyebrow"><span></span> Solicitud recibida</p><h3>Gracias por confiar en ${brandName}.</h3><p>Recibimos tus datos. Nuestro equipo revisará la información antes de contactarte.</p><a class="text-link" href="#inicio">Volver al inicio <span aria-hidden="true">↑</span></a></div><details class="privacy-note" id="privacidad"><summary>Aviso de privacidad</summary><div><p><strong>Responsable:</strong> ${responsible}.</p><p><strong>Finalidad:</strong> analizar tu solicitud inmobiliaria y contactarte para explicarte si ${brandName} puede ayudarte. No solicitamos documentos ni datos financieros en esta etapa.</p><p><strong>Tus derechos:</strong> puedes solicitar acceso, rectificación, eliminación u oposición usando este mismo formulario e indicando “Privacidad” en el mensaje.</p><p>La información no se utiliza para decisiones automatizadas ni se entrega a terceros para fines publicitarios.</p></div></details></div></div></section>`;
}

function renderFooter(page) {
  const home = page.route === "/";
  const copyright = home ? "Brena Gestión Inmobiliaria" : "BRENA";
  return `<footer class="site-footer"><div class="shell footer-top"><div><img src="/brena.png" width="500" height="115" alt="BRENA"><p>Soluciones claras para propiedades complejas.</p></div><nav aria-label="Navegación de pie de página"><a href="${home ? "#situaciones" : "/#situaciones"}">¿Podemos ayudarte?</a><a href="${home ? "#proceso" : "/#proceso"}">Cómo funciona</a><a href="#preguntas">Preguntas frecuentes</a><a href="#privacidad">Privacidad</a></nav></div><div class="shell footer-bottom"><p>© <span data-current-year>2026</span> ${copyright}.</p><p>Chile</p></div></footer>`;
}
...
function renderPage(page, pages = PAGES) {
  ...
  const websiteProperties = page.route === "/"
    ? `\n  <link itemprop="url" href="${escapeHtml(SITE_IDENTITY.siteUrl)}">\n  <meta itemprop="name" content="${escapeHtml(SITE_IDENTITY.name)}">`
    : "";
  return `<!doctype html>
<html lang="es-CL" data-page-type="${page.pageType}">
${renderHead(page)}
<body${page.route === "/" ? ` itemscope itemtype="https://schema.org/WebSite" itemid="${escapeHtml(SITE_IDENTITY.websiteId)}"` : ""}>${websiteProperties}
